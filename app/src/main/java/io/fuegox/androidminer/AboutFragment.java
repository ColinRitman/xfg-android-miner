...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnDonateETH.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Utils.copyToClipboard("Fuego ETH Donation Address", Utils.FUEGO_ETH_ADDRESS);
                Toast.makeText(getContext(), getResources().getString(R.string.donationadresseth_copied), Toast.LENGTH_SHORT).show();
            }
        });

        Button btnDonateXFG = view.findViewById(R.id.btnDonateUPX);
        btnDonateXFG.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Utils.copyToClipboard("Fuego XFG Donation Address", Utils.FUEGO_XFG_ADDRESS);
        ...
        tvuPlexa.setText(Html.fromHtml(getString(R.string.fuegoLink)));
