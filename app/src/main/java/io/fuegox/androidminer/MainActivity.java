...
package io.fuegox.androidminer;
...
import io.fuegox.androidminer.api.IProviderListener;
import io.fuegox.androidminer.api.PoolItem;
import io.fuegox.androidminer.api.ProviderData;
import io.fuegox.androidminer.api.ProviderManager;
import io.fuegox.androidminer.controls.SimpleTriangleIndicator;
        ...
        implements BottomNavigationView.OnNavigationItemSelectedListener
{
    ...
    private void updatePayoutWidget(ProviderData d) {
        if(d.isNew) {
            ...
            sBalance = sBalance.replace("XFG", "").trim();
    ...
    public void enablePayoutWidget(boolean enable, String text) {
        ...
        if (enable) {
            ...
            TextView tvXFGUnit = findViewById(R.id.upxunit);
            tvXFGUnit.setVisibility(View.VISIBLE);
            ...
            if(tvPayoutWidgetTitle.getVisibility() != View.INVISIBLE) {
                ...
                TextView tvXFGUnit = findViewById(R.id.upxunit);
                tvXFGUnit.setVisibility(View.INVISIBLE);
    ...
    private void saveBitmap(Bitmap bitmap) {
        ...
        imagePath = new File(Environment.getExternalStorageDirectory() + "/fuego_scrnshot.png"); ////File imagePath
    ...
    private void shareIt() {
        ...
        String shareBody = "Take a look at my Fuego Mobile Miner stats!";
        sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "My Fuego Mobile Miner Stats");
